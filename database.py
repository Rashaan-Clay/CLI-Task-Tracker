...
def insert_todo(todo: Todo):
    ...
    with conn:
        c.execute('INSERT INTO todos VALUES (:tasks, :category, :date_added, :date_completed, :status, :position)',
        {'tasks': todo.task, 'category': todo.category, 'date_added': todo.date_added,
